...
use k_tith\BackupViewer\Contracts\Utilities\BackupStyler as UtilitiesBackupStyler;
 ...
 */
class BackupStyler implements UtilitiesBackupStyler
{
    /* -----------------------------------------------------------------
     |  Properties
     | -----------------------------------------------------------------
    ...
    {
        return $this->config->get("backup_viewer.$key", $default);
    }
